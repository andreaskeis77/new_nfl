...
def build_parser() -> argparse.ArgumentParser:
    ...
    set_state = sub.add_parser('set-pipeline-state', help='Upsert one pipeline state record')
    ...
    show_state = sub.add_parser('show-pipeline-state', help='Show one pipeline state record')
...
def main() -> int:
    ...
    if args.command == 'set-pipeline-state':
        return _cmd_set_pipeline_state(args.pipeline_name, args.run_status, args.state_json)
