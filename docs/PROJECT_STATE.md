...
**T2.5D Rosters-Domäne (bitemporal)** — abgeschlossen (2026-04-22). Nächster Bolt: T2.5E (Team Stats Aggregate).
...
**T2.5E — Team Stats Aggregate** gemäß `T2_3_PLAN.md` §4: `core.team_stats_weekly` aus nflverse (Tier-A) + `official_context_web` (Tier-B, Cross-Check auf Saison-Aggregate), `mart.team_stats_weekly_v1` und `mart.team_stats_season_v1` als Read-Projektionen. Erste aggregierende Domäne — Bye-Week-Behandlung und Saison-Summen sind die neuen Risiken. Das T2.5D-Protocol-Round-Trip-Muster gilt weiter (`CoreTeamStatsLoadResult` erfüllt `CoreLoadResultLike`).
